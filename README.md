...
[![version](https://img.shields.io/npm/v/rn-svg-charts.svg)](https://www.npmjs.com/package/rn-svg-charts)
[![downloads](https://img.shields.io/npm/dm/rn-svg-charts.svg)](https://www.npmjs.com/package/rn-svg-charts)
[![license](https://img.shields.io/npm/l/rn-svg-charts.svg)](https://www.npmjs.com/package/rn-svg-charts)

Welcome to rn-svg-charts!

`rn-svg-charts` provides SVG Charts support to React Native on iOS and Android, and a compatibility layer for the web.
...
See [releases](https://github.com/mdmush/rn-svg-charts/releases) for more information.

---

In order to not bloat this README too much we've moved some examples over to
[`rn-svg-charts-examples`](https://github.com/mdmush/rn-svg-charts-examples).
...
```
yarn add rn-svg-charts
```

or npm:

```
npm install --save rn-svg-charts
```
...
![Area chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/area-chart.png)

#### Example

```jsx
import React from 'react'
import { AreaChart, Grid } from 'rn-svg-charts'
...
See [Area stack chart with Y axis](https://github.com/mdmush/rn-svg-charts-examples/blob/master/storybook/stories/area-stack/with-y-axis.js) to see how to use a YAxis with this component
Use the `svgs` prop to pass in `react-native-svg` compliant props to each area.

![Stacked area chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/area-stack.png)

#### Example

```jsx
import React from 'react'
import { StackedAreaChart } from 'rn-svg-charts'
import * as shape from 'd3-shape'
...
![Bar chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/bar-chart.png)

#### Example

```jsx
import React from 'react'
import { BarChart, Grid } from 'rn-svg-charts'
...
![Stacked bar chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/bar-stack.png)
![Stacked bar chart - horizontal](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/bar-stack-horizontal.png)

#### Example

```jsx
import React from 'react'
import { StackedBarChart } from 'rn-svg-charts'
...
![Line chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/line-chart.png)

#### Example

```jsx
import React from 'react'
import { LineChart, Grid } from 'rn-svg-charts'
...
See more examples in the [examples repo](https://github.com/mdmush/rn-svg-charts-examples)

![Pie chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/pie-chart.png)

#### Example

```jsx
import React from 'react'
import { PieChart } from 'rn-svg-charts'
...
| Property      | Default                      | Description                                                                                                                                                                                                                                                                                                                                 |
| ------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| data          | **required**                 | Very similar to the data prop of our other charts, the only exception is that the PieChart only accepts complex objects (not just numbers). An item can also contain the `arc` property which allows you two override settings on that specific arc. See [examples repo](https://github.com/mdmush/rn-svg-charts-examples) |
...
![Progress circle](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/progress-circle.png)

#### Example

```jsx
import React from 'react'
import { ProgressCircle } from 'rn-svg-charts'
...
![Y-axis](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/y-axis.png)
...
```jsx
import React from 'react'
import { LineChart, YAxis, Grid } from 'rn-svg-charts'
...
![Line chart](https://raw.githubusercontent.com/mdmush/rn-svg-charts/master/screenshots/x-axis.png)
...
```jsx
import React from 'react'
import { LineChart, XAxis, Grid } from 'rn-svg-charts'
import { View } from 'react-native'
...
simply add the prop `belowChart={true}`. There's a ton of examples in the [examples repo](https://github.com/mdmush/rn-svg-charts-examples), go and have a look.
...
There are tons of examples over at [react-native-svg-chart-examples](https://github.com/mdmush/rn-svg-charts-examples)
